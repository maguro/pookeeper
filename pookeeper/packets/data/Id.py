...
class Id:
    ...
    def serialize(self, output_archive, tag):
        ...
        output_archive.write_string(self.id, 'id')
    ...
    def deserialize(self, input_archive, tag):
        ...
        self.id = input_archive.read_string('id')
        input_archive.end_record(tag)

    def __repr__(self):
        return 'Id(%r, %r)' % (self.scheme, self.id)

    def __eq__(self, other):
        return self.scheme == other.scheme and self.id == other.id
