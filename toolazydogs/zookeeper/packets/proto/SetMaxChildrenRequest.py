...
class SetMaxChildrenRequest:
    ...
    def serialize(self, output_archive, tag):
        ...
        output_archive.write_int(self.max, 'max')
    ...
    def deserialize(self, input_archive, tag):
        ...
        self.max = input_archive.read_int('max')
        input_archive.end_record(tag)

    def __repr__(self):
        return 'SetMaxChildrenRequest(%r, %r)' % (self.path, self.max)

    def __eq__(self, other):
        return self.path == other.path and self.max == other.max

    def __ne__(self, other):
        return not self.__eq__(other)

    def __hash__(self):
        return hash((self.path, self.max))
